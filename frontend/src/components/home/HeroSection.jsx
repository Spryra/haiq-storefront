...
export default function HeroSection() {
  ...
  useEffect(() => {
    // Two rAF frames: first ensures the component is painted, second triggers
    // the entrance. Replaces window.load listener (which fires before the
    // component mounts in a SPA) and setTimeout(80ms) (arbitrary).
