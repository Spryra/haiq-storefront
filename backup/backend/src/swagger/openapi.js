      ...
      schemas: {
        ...
        CreateOrderRequest: {
          ...
          properties: {
            ...
            payment_method: { type: 'string', enum: ['mtn_momo', 'airtel', 'bank_transfer'] },
            payer_phone: { type: 'string', example: '+256701234567', description: 'Phone for mobile money (can differ from contact phone)' },
